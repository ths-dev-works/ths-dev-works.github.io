...
Backend Engineer experienced in building scalable, cloud-native systems in fintech and telecom. Expert in Go, focused on performance, reliability, and developer experience. Delivered mission-critical services running in high-traffic production environments.

## Technical Stack

### Languages & Core
- **Go (Golang)** — Primary language for microservices and high-performance systems

### Databases
- **PostgreSQL** — Relational database for transactional workloads
- **MongoDB** — NoSQL database for flexible data models

### Messaging & Queues
- **NATS** — Lightweight messaging for microservices communication
- **NSQ** — Distributed message queue system
