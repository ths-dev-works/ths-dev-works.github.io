...
3. **Ponteiros São para Partilha**: Se não está a partilhar dados através de limites, para ficar com valores
...
- **Para fazer** uma chamada de função significa que a goroutine precisa de enquadrar uma nova secção de memória no stack
